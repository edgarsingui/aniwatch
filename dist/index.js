    ...
    $(`${selector} .pre-qtip-line`).each((_, el) => {
      ...
      switch (key) {
        ...
        case "status":
          ...
          break;
        case "genres":
          res.anime.genres = value?.split(",")?.map((i2) => i2?.trim()) || [];
          break;
      }
    });
    return res;
...
var embed_url = "https://megacloud.blog/embed-2/e-1/";
    ...
    wbg: {
      ...
      __wbg_call_67f2111acd2dfdb6: function() {
        return applyToWindow(function(index2, index22, index3) {
          return addToStack(
            get(index2).call(get(index22), get(index3))
          );
        }, arguments);
      },
      ...
      __wbg_newwithbyteoffsetandlength_0de9ee56e9f6ee6e: function(index2, val, val2) {
        return addToStack(
          new Uint8Array(get(index2), val >>> 0, val2 >>> 0)
        );
      },
...
async function getSources(xrax) {
  ...
  try {
    await V();
    let getSourcesUrl = `https://megacloud.blog/embed-2/v2/e-1/getSources?id=${xrax}`;
...
async function getEstimatedSchedule(date, tzOffset = -330) {
  ...
  try {
    ...
    const $ = load14(mainPage?.data?.html);
    const selector = "li";
